...
users
  ...
  .put(authenticate, uploadHandler.single('avatar'), updateUserValidator, updateUserController);

users.route('/password').put(authenticate, updatePasswordValidator, updatePasswordController);
